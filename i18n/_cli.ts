...
function renderResources(
  ...
  return `// This file is generated by @fragment/i18n. Do not edit.\n\n` +
    `import type projectConfig from ${typescriptString(configImport)};\n` +
    `import type { InferConfiguredI18nTypes } from '@fragment/i18n/config';\n` +
    `${imports}\n\n` +
...
function renderRuntime(configImport: string): string {
  return `// This file is generated by @fragment/i18n. Do not edit.\n\n` +
    `import { createI18n as createRuntime } from '@fragment/i18n';\n` +
    `import { getI18nPlugin } from '@fragment/i18n/config';\n` +
